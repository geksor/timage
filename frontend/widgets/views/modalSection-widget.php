    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title main__about-popup-info-text" id="exampleModalLongTitle">
                    <? if (!$model->section_name) {?>
                        Заказать расчет
                    <?}else{?>
            ...
            <div style="display: none">
                ...
                <?= $form->field($model, 'section_name')->label(false) ?>
            </div>
